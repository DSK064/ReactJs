...
import logo from './Pages/facebook_logo.jpg'
    ...
    <div className="App">
      <div id='navBar'>
        ...
        <nav id='navBar'>
          ...
          <button id='btn1'><Link to="/"><AiFillHome/></Link></button>
          <button id='btn2'><Link to="/Page4"><HiShoppingBag/></Link></button>
          <button id='btn3'><Link to="/Page3"><MdOndemandVideo/></Link></button>
          <button id='btn4'><Link to="/page2"><GoPerson/></Link></button>
